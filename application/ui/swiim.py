...
class Ui_swiimQMainWindow(object):
    def setupUi(self, swiimQMainWindow):
        ...
        self.testWiimoteAction = QtGui.QAction(swiimQMainWindow)
        self.testWiimoteAction.setObjectName("testWiimoteAction")
        self.homeAction = QtGui.QAction(swiimQMainWindow)
        self.homeAction.setObjectName("homeAction")
        self.menu_Tools.addAction(self.testWiimoteAction)
        self.menubar.addAction(self.menu_File.menuAction())
        self.menubar.addAction(self.menu_Tools.menuAction())
        self.menubar.addAction(self.menu_Help.menuAction())
        self.toolBar.addAction(self.testWiimoteAction)
    ...
    def retranslateUi(self, swiimQMainWindow):
        ...
        self.testWiimoteAction.setText(QtGui.QApplication.translate("swiimQMainWindow", "Test &Wiimote", None, QtGui.QApplication.UnicodeUTF8))
        self.testWiimoteAction.setToolTip(QtGui.QApplication.translate("swiimQMainWindow", "Test connection with the Wiimote", None, QtGui.QApplication.UnicodeUTF8))
        self.homeAction.setText(QtGui.QApplication.translate("swiimQMainWindow", "&Home", None, QtGui.QApplication.UnicodeUTF8))
        self.homeAction.setToolTip(QtGui.QApplication.translate("swiimQMainWindow", "Go to the home screen", None, QtGui.QApplication.UnicodeUTF8))
